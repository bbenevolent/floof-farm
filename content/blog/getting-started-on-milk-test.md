---
title: "Getting Started on Milk Test"
date: 2023-09-16T08:32:57-08:00
draft: false
slug: "getting-started-on-milk-test"
categories:
  - "Blog"
author: "wonderchook"
---
...
When I say I'm doing "milk test" what I'm saying is that I'm participating in [Dairy Herd Improvement for the Registry](https://adga.org/performance-programs/) which is an American Dairy Goat Association Performance Program. Milk test is a sampling program. You can get information on milk production and components which is then tied to that goat, her relatives and compared to others of the breed. There are various awards that can be won through this program, but for this post I'm just going to focus on the process. 

## DHIA Labs

To participate you need to sign-up with ADGA, sign-up with a lab and take a test to get certified as a milk tester. I currently use [Langston University's lab](https://www.langston.edu/about-goat-research-center), but I have used others in the past. After this you will on ideally a monthly basis weigh, take sample, record information and send them to this lab. This then is recorded and you receive information back about both the samples and estimates of how much the goat has milked and how much she potentially will milk over a 305 day lactation. 
...
**Owner Sampler (O/S 40)**: For Owner Sampler you the herd owner do most of your sampling and mailing of your samples, except for one test day where you need someone else to supervise it. This plan sounds much simpler, right? Well in some ways it is, but you have to perform at least eight tests and does need to be milk for at least 240 days. This form of testing is not eligible for the [Top 10 Breed Leaders Awards](https://adga.org/top-ten-breed-leaders/), which are the Top 10 goats in production for each breed. 
...
There are many types of awards one can get with milk records. The main one that I'm working on are the *M which is the main type of milk star. The minimum's required are [available here](https://adga.org/m-levels/). There are many other awards that may be relevant to you including [Superior Genetics](https://adga.org/performance-programs/genetics-award-programs/superior-genetics/), Top Ten Breed Leader and [Elite List](https://adga.org/performance-programs/elite-status/). I'm not going to go into those here, but may break them down in another post someday. 

At Floof Farm our first goat to earn her *M in all 3 components was [Floof Farm BS Katsu](https://floof.farm/2021/07/06/floof-farm-bs-katsu/), quite a few have earned theirs in butterfat and protein. 
