---
title: "Goating into 2024"
date: 2024-01-01T08:22:06-08:00
draft: false
slug: "goating-into-2024"
categories:
  - "Blog"
tags:
  - "competitive goating"
...
In 2023 [lambars were the big change for us in terms of kid rearing](https://floof.farm/2023/10/22/how-we-raise-goat-kids-currently/). They made a huge difference. I still felt like I was spending a lot of time warming milk, feeding kids, washing milk receptacles. I want to try free feeding milk in 2024 also known as ad libitum milk. 

Many commercial dairies do ad libitum this and I'm curious to see if it work for me. Key is that the milk is cold so the kids don't stuff themselves on it. I'm going to to have build a set-up for this and haven't quite decided what I will use yet. I read a [blog post from Pholia Farm](https://pholiafarm.com/herd-management/kid-management/) about their attempts using this and their other kid management. The kids had a higher quantity of urine output making things pretty sloppy. I'm curious to see if I will see the same results with my Nigerians. 
...
There is a formulation designed to be put in milk called [DECCOX-M](https://www.zoetisus.com/products/cattle/deccox). I plan is to buy a bag of this and start adding it to milk 2x a day. What I haven't figured out is if it is okay to do this with the ab libitum milk feeding. If I have to pick one thing to try it will be the deccox. 
...
I plan to go to [ADGA Convention in 2024](https://convention.adga.org/), I intended to go in 2023 but was still milking quite a few goats so it was hard to get away. I am kidding much earlier in 2024, so that shouldn't be an issue. 
...
I tried to not set too many goals so that I am able to stay focused. The one overarching goal is not to commit to do too many things. This could be taking too many animals to a show or attending too many shows. Or trying to keep too many does in milk for test. Whatever it is I want to make sure [competitive goating](https://floof.farm/2023/12/26/competitive-goating-so-you-want-to-show-goats/) stays fun in 2024.